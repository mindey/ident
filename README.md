...
```
2. User runs locally, and produces signed message with their public key included after `:`, and pastes to server textarea box:
```
$ solve MyRandomChallengeMessage
```

3. Server extracts the public key, and verifies the signed challenge. If the challenge is correctly signed by the private key of public key owner, the public key is added as user.
